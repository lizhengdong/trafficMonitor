package com.trafficMonitor.utils.ID3;
...
/**
 * Created by lizhengdong on 11/18/15.
 * Author: lizhengdong
 * MailBox: 837718866@qq.com
 * Update by lizhengdong on 11/18/15.
 * Description: ID3
 */
public class ID3 {
    ...
    public static void main(String[] args) {
        ID3 inst = new ID3();
        inst.readARFF(new File("/Users/lizhengdong/Desktop/papers/weather.nominal.arff"));
        inst.setDec("play");
        ...
        inst.writeXML("/Users/lizhengdong/Desktop/papers/dt.xml");
        return;
    }
